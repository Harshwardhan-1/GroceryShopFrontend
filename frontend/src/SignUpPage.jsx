...
export default function HomePage(){
    ...
    useEffect(()=>{
        const fetch=async()=>{
            const response=await axios.get("https://grocery-store-backend-1.onrender.com/api/all/getAll");
    ...
    const handle=async(e)=>{
        ...
        const response=await axios.post("https://grocery-store-backend-1.onrender.com/api/all/signup",send,{withCredentials:true});
