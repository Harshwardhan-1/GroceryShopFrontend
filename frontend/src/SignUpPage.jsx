...
export default function HomePage(){
    ...
    useEffect(()=>{
        const fetch=async()=>{
            const response=await axios.get("https://groceryshopbackend-3.onrender.com/api/all/getAll");
    ...
    const handle=async(e)=>{
        ...
        const response=await axios.post("https://groceryshopbackend-3.onrender.com/api/all/signup",send,{withCredentials:true});
