  ...
  useEffect(()=>{
    const fetchUser = async ()=>{
      const response = await axios.get("https://grocery-store-backend-1.onrender.com/api/all/particularUser",{withCredentials:true});
  ...
  const handlemulter=async(e)=>{
    ...
    const response=await axios.post("https://grocery-store-backend-1.onrender.com/api/all/profilePic",formData,{withCredentials:true,headers:{"Content-Type":"multipart/form-data",},});
    setData(response.data.data);
  }
        ...
        {data && (
          <div className="profile-box">
            <div className="profile-image-wrapper">
              <img src={data.profilePic ? `https://grocery-store-backend-1.onrender.com/uploads/${data.profilePic}` 
